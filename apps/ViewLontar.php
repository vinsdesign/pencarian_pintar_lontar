...
$sparql = sparql_get(
    "http://localhost:3030/lontar_ontologi/query",
    ...
    PREFIX lontar:<http://www.semanticweb.org/sarasvananda/ontologies/2023/5/untitled-ontology-12#>
        ...
        SELECT ?title ?type ?author ?subject ?classification ?language ?collation ?year ?length ?width ?resource ?placename ?location ?area ?regency
        WHERE {
