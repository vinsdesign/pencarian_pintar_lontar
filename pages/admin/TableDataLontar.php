                    ...
                    <div class="flex items-center gap-5 ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="https://lontarbali.id/pages/admin/DetailDataAdmin.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Profile</a>
                                </li>
                                <li>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <td class="w-4 px-5 py-3">
                                        <div class="flex gap-2 text-lg text-darkBlue items-center">
                                            ...
                                            |
                                            <a href="https://lontarbali.id/pages/admin/DetailDataLontar.php?id=<?= $row->title; ?>"><button type="button" class="hover:text-success"><i class="fa-solid fa-circle-info"></i> </button> </a>
                                        </div>
                                    </td>
