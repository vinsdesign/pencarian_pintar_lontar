                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <td class="w-4 px-5 py-3">
                                        <div class="flex gap-2 text-lg text-darkBlue items-center">
                                            ...
                                            |
                                            <a href="https://vinsjs.site/lontar_bali/pages/admin/DetailDataLontar.php?id=<?= $row->title; ?>"><button type="button" class="hover:text-success"><i class="fa-solid fa-circle-info"></i> </button> </a>
                                        </div>
                                    </td>
