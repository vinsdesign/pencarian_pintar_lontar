                    ...
                    <div class="flex w-full flex-col justify-center items-center">
                        <div class="w-full max-w-3xl p-5 my-5 bg-white border border-gray-200 rounded-xl shadow dark:bg-gray-800 dark:border-gray-700">
                            <div class="flex justify-between px-4">
                                <a href="<?= BASE_URL ?>pages/admin/DashboardAdmin.php"><button class="mt-2 mb-4 hover:bg-darkBlue px-5 py-2 text-white rounded-full bg-lightBlue hover:transition-all hover:delay-100"><i class="fa-solid fa-angle-left"></i> Kembali</button></a>
