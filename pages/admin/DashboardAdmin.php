                    ...
                    <div class="flex items-center gap-5 ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="https://lontarbali.id/admin/DetailDataAdmin.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Profile</a>
                                </li>
                                <li>
                                    <a href="https://lontarbali.id/apps/Logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Sign out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="grid grid-rows-2 grid-flow-col gap-3">
                    ...
                    <div class="col-span-2 bg-lightSecondary flex items-center justify-between gap-3 px-10 rounded-2xl">
                        <div class="flex flex-col justify-between gap-2 ">
                            ...
                            <div>
                                <a href="https://lontarbali.id/pages/admin/DetailDataAdmin.php"><button type="button" class="py-2 px-5 me-2 mb-2 text-sm font-medium bg-darkBlue text-white focus:outline-none mt-1 rounded-full border border-gray-200 hover:bg-mediumBlue focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                        Lihat Profile
                                    </button></a>
                            </div>
                        </div>
